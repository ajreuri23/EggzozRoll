export const TELEGRAM_BOT_TOKEN = '7201937507:AAE2reSehuIpgSn5bpc9xV_SYywRbOGuwus';
export const TELEGRAM_CHAT_ID = -4561579077;
export const CSGOROLL_API_URL = 'https://api.csgoroll.com/graphql';
